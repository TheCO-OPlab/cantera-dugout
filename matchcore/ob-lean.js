...
(function (root) {
  ...
  function card(o, i, h) {
    ...
    var chips = rs.map(function (r) {
      ...
      return '<span class="lo sv-' + r.sev + '" data-sev="' + r.sev + '" title="' + String(r.short).replace(/"/g, '&quot;') + '">' + h.icon(r.kind || r.icon) +
  ...
  function details(o, rs, h) {
    ...
    var mods = (o.mods || []).concat(o.theirMods || []);
    if (mods.length) {
      h.nmReset();
      ...
      s += '<span class="ld-mods">' + (o.mods || []).map(function (m) { return h.nm(line(me, m)); }).concat((o.theirMods || []).map(function (m) { return h.nm(line(them, m)); })).join('<br>') + '</span>';
    } else if (o.bonus) {
